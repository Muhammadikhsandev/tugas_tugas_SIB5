                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            ...
                            <a href="{{url('admin/jenis_produk')}}">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Data Jenis Produk
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$jenis_produk}}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    Char data dari produk dengan total produk {{$produk}}
                                </div>
                            </div>
                        </div>
